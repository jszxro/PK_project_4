...
public class DiaryController {
    ...
    public ResponseEntity<List<DiaryDTO>> getDiariesByUserKey(@PathVariable("userKey") String userKey) {
    ...
    @PutMapping("/{diaryId}")
    public ResponseEntity<String> updateDiary(@PathVariable("diaryId") String diaryId, @RequestBody DiaryDTO request) {
